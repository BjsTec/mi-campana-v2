    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <input
          ...
          onBlur={() => {
            // También se puede activar en onBlur para búsquedas finales
        ...
        {foundUser && (
          <div className="mt-2 p-2 bg-primary-50 border border-primary-200 rounded-md flex items-center justify-between">
            {' '}
            {/* Usando primary-50 y primary-200 */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="relative">
          {' '}
          {/* Añadido relative para posicionar el botón de ojo */}
          <label
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          >
            ...
            {candidateCiudades.map(
              (
                ciu, // Usar candidateCiudades
              ) => (
