...
export async function middleware(request) {
  ...
  if (!sessionCookie) {
    ...
    console.log('Middleware: No se encontró cookie de sesión. Redirigiendo a /login');
  ...
  if (!jwtSecret) {
    console.error('Middleware: La clave secreta JWT no está configurada. Protege tus rutas.');
