...
const clientesPotenciales = [
  {
    ...
    mensaje: 'Hola, estoy interesada en sus servicios de rotulación de vehículos. ¿Podrían darme más información sobre los precios?',
    fecha: '2025-07-03',
  },
  {
    id: 'cli-002',
    ...
    mensaje: 'Necesito una cotización para 1000 tarjetas de presentación y 5 pendones. Gracias.',
    fecha: '2025-07-02',
  },
  {
    id: 'cli-003',
    ...
    mensaje: 'Quisiera saber si ofrecen diseño de sitios web para pequeñas empresas. Me gustaría ver su portafolio.',
    fecha: '2025-07-01',
  },
  {
    id: 'cli-004',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {clientesPotenciales.map((cliente) => (
            // Tarjeta de cliente
            <div key={cliente.id} className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col">
              ...
              <div className="p-4 flex-grow">
                <p className="text-sm text-gray-700 mb-2">
                  <strong className="font-medium text-gray-800">Email:</strong> {cliente.email}
                </p>
                <p className="text-sm text-gray-700 mb-4">
                  <strong className="font-medium text-gray-800">Teléfono:</strong> {cliente.telefono}
                </p>
                ...
                <div className="mt-2 p-3 bg-gray-50 rounded-md border border-gray-200 h-full">
                  ...
                  <p className="text-sm text-gray-600 italic mt-1">{cliente.mensaje}</p>
                </div>
              </div>
            </div>
          ))}
