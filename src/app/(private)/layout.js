...
export default function ExternalClientDashboardLayout({ children }) {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col bg-gray-50"> {/* Fondo general de la página más claro */}
          ...
          <nav className="flex flex-col gap-2.5 flex-grow">
            ...
            {user.role === 'admin' && (
              <>
                ...
                >
                  <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h2a2 2 0 002-2V7a2 2 0 00-2-2h-2v3m-2 10a2 2 0 01-2 2H7a2 2 0 01-2-2V7a2 2 0 012-2h2v3m-2 10h2a2 2 0 002-2V7a2 2 0 00-2-2h-2v3m-2 10a2 2 0 01-2 2H7a2 2 0 01-2-2V7a2 2 0 012-2h2v3"></path>
                  </svg>
            ...
            >
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m0 0l7-7 7 7M19 10v10a1 1 0 01-1 1H8a1 1 0 01-1-1v-4m0 0L3 4m0 0l-2 2m2-2m4 0l4 4"></path>
              </svg>
              Mi Panel Cliente
            </a>
          </nav>
