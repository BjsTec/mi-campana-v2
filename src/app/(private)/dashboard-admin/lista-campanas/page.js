...
const simulatedUsers = [
  { id: 1, nombre: 'Ana García', ocupacion: 'Abogada', cedula: '1012345678', activo: true },
  { id: 2, nombre: 'Luis Pérez', ocupacion: 'Ingeniero', cedula: '1098765432', activo: false },
  { id: 3, nombre: 'Marta Díaz', ocupacion: 'Diseñadora', cedula: '1054321098', activo: true },
  { id: 4, nombre: 'Pedro Gómez', ocupacion: 'Vendedor', cedula: '1087654321', activo: true },
  { id: 5, nombre: 'Sofía Castro', ocupacion: 'Contadora', cedula: '1023456789', activo: false },
  { id: 6, nombre: 'Juan Latorre', ocupacion: 'Médico', cedula: '1000000001', activo: true },
  { id: 7, nombre: 'Elena Ramírez', ocupacion: 'Arquitecta', cedula: '1000000002', activo: false },
  { id: 8, nombre: 'Carlos Ortiz', ocupacion: 'Programador', cedula: '1000000003', activo: true },
];
...
export default function ListaUsuariosPage() {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Lista de Usuarios Simulados</h1>
      <p className="text-gray-600 mb-6">
        Aquí puedes ver una simulación de los usuarios registrados en el sistema.
      </p>

      {user && user.role === 'admin' ? (
        // Contenedor para las tarjetas, usando un grid responsivo
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"> {/* SOLO LAYOUT DE GRID AQUÍ */}
          {simulatedUsers.map((usuario, index) => ( // <-- El map correcto con 'index'
            <div
              key={usuario.id}
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold text-gray-900">{usuario.nombre}</h2>
              ...
              <p className="text-gray-700 mb-2">
                <span className="font-medium">Ocupación:</span> {usuario.ocupacion}
              </p>
